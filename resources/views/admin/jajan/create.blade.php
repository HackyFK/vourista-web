...
@section('title', 'Tambah Jajanan - Admin Vourista')
@section('page-title', 'Tambah Jajanan')
...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="bg-gradient-to-r from-green-500 to-teal-500 p-6">
            <h2 class="text-2xl font-bold text-white">Tambah Jajanan Baru</h2>
            <p class="text-green-100 mt-1">Lengkapi informasi jajanan yang akan ditambahkan</p>
        </div>
        
        <div class="p-6">
            <form method="POST" action="{{ route('admin.jajan.store') }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                
                <!-- Title -->
                <div>
                    <label for="judul" class="block text-sm font-semibold text-gray-700 mb-2">
                        <i class="fas fa-heading mr-2 text-green-500"></i>Judul Jajanan
                    </label>
                    <input 
                        type="text" 
                        id="judul" 
                        name="judul" 
                        value="{{ old('judul') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent transition-all duration-200 @error('judul') border-red-500 @enderror"
                ...
                <div>
                    <label for="deskripsi_singkat" class="block text-sm font-semibold text-gray-700 mb-2">
                        <i class="fas fa-align-left mr-2 text-green-500"></i>Deskripsi Singkat
                    </label>
                    <textarea 
                        id="deskripsi_singkat" 
                        name="deskripsi_singkat" 
                        rows="3"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent transition-all duration-200 @error('deskripsi_singkat') border-red-500 @enderror"
                        placeholder="Masukkan deskripsi singkat jajanan (akan ditampilkan di kartu)"
                        required
               ...
               <!-- Long Description -->
                ...
                <div>
                    <label for="gambar" class="block text-sm font-semibold text-gray-700 mb-2">
                        <i class="fas fa-image mr-2 text-green-500"></i>Gambar Jajanan
                    </label>
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-green-400 transition-colors duration-200 @error('gambar') border-red-500 @enderror">
                        <input 
                            type="file" 
                            id="gambar" 
                            name="gambar" 
                        ...
                        <div id="upload-area" onclick="document.getElementById('gambar').click();" class="cursor-pointer">
                            ...
                            <p class="text-gray-600 mb-1">Klik untuk memilih gambar</p>
                        ...
                        <div id="preview-area" class="hidden">
                            ...
                            <p class="text-sm text-green-600 mt-2">Gambar berhasil dipilih</p>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                    <button 
                        type="submit" 
                        class="flex-1 bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105"
                    >
                        <i class="fas fa-save mr-2"></i>Simpan Jajanan
                    </button>
                    <a 
